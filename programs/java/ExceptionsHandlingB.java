...
the output contains "n and p should be non-negative". If both n and p are zero, the output contains "n and p 
should not be zero.". This is printed by the locked stub code in the editor.
 ...
 */
public class ExceptionsHandlingB {
    public static long power(int n, int p) throws Exception{
        ...
        if (n < 0 || p < 0){
            ...
            Double val = Math.pow(Double.valueOf(n), Double.valueOf(p));
            num = Double.valueOf(val).longValue();
        }
    ...
    public static void main(String[] args) throws Exception{
        ExceptionsHandlingB.power(9, 7);
        ExceptionsHandlingB.power(0, 0);
        ExceptionsHandlingB.power(9, -9);
        ExceptionsHandlingB.power(-9, -7);
    }
}
